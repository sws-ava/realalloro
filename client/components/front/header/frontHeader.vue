<template>
  <header
    ...
    :class="scrollPosition > 200 ? ' sticky' : ' header-transparent-on'"
  >
    <div class="container">
      <!-- NAVIGATION MENU -->
      <div class="navik-header-container">
        ...
        <!-- CALL BUTTON -->
        <div class="callusbtn">
          <a :href="'tel:' + $t('static.phone1full')">
        ...
        <!-- LOGO IMAGE -->
        <div class="logo">
          <nuxt-link :to="localePath('mainPage')">
        ...
        <!-- BURGER MENU -->
        <div @click="activeBurger" class="burger-menu" ref="mobileMenu">
        ...
        <nav class="navik-menu menu-caret navik-yellow">
          ...
          <div class="logoCenter" style="width: 151.453px">
            <div :class="scrollPosition > 200 ? 'logo' : 'logo bgWhite'">
              <nuxt-link :to="localePath('mainPage')">
                <img src="/logo.png" alt="header-logo" />
              </nuxt-link>
            </div>
